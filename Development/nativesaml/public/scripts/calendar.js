...
$(document).ready(function() {
  $('#reservationtime').mask('00.00.0000 - 00.00.0000');
  $('#datepicker').mask('00.00.0000');
  $('#reservationtime').daterangepicker({ format: 'DD.MM.YYYY', showDropdowns: true });
  $('#datepicker').daterangepicker({ format: 'DD.MM.YYYY', showDropdowns: true, singleDatePicker: true });
});